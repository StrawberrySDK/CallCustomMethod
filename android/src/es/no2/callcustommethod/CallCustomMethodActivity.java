...
package es.no2.callcustommethod;

import es.no2.no2gl.MainActivity;
import android.os.Bundle;
import android.widget.Toast;

public class CallCustomMethodActivity extends MainActivity
{
    @Override
    ...
    public void sayHello() {
        Toast.makeText(this, "Hello CallCustomMethod!!!!!", Toast.LENGTH_LONG).show();
    }
}
